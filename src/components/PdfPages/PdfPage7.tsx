        ...
        return (
            <div ref={ref} className="relative h-[1700px] text-xl text-neutral-900">
                ...
                <div className="h-full ps-10 pe-48">
                    <div className="h-full border-s pb-16 flex flex-col justify-between ps-12">
                        <div>
                                            ...
                                            <div className="flex gap-8">
                                                ...
                                                <div>
                                                    ...
                                                    <p>
                                                        ...
                                                        Fully functional AI Voice Bot capable of handling specified roles using voice
                                                        channels.
                                            ...
                                            <div className="flex gap-6">
                                                ...
                                                <div  >
                                                    ...
                                                    <p>
                                                        ...
                                                        Seamless integration of AI Voice Bot with designated communication channels
                                                        (messaging platforms, web interfaces).
                                                    </p>
                                            ...
                                            <div className="flex gap-6">
                                                ...
                                                <div  >
                                                    ...
                                                    <p>
                                                        ...
                                                        Detailed documentation covering AI functionalities, training protocols, integration
                                            ...
                                            <div className="flex gap-6">
                                                ...
                                                <div  >
                                                    ...
                                                    <p>
                                                        ...
                                                        Resources and training sessions for internal teams to effectively manage and
                                                        oversee the deployed AI agents.
                                                    </p>
                        ...
                        {
                            (formInputs.proposalType === "Agent PRO" || formInputs.proposalType === "Agent LIVE" || formInputs.proposalType === "Agent ESSENTIAL") && <div className="mt-10">
                                <p> <span className="font-semibold">Note : </span> Integration with CRM is not covered underthe scope of this proposal.
                                </p>
                            </div>
                        }
